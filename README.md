...
# StreamFlow v2.2: Fresh From The Oven [Custom Features By UFSEAN]🔥
...
- **Auto Playlist Switching** – Playlist dapat berpindah otomatis berdasarkan jadwal harian per stream, lengkap dengan validasi overlap lintas hari, prioritas, dan dukungan timezone Asia/Jakarta.
- **Playlist Schedule Manager** – Dashboard menyertakan toggle auto playlist serta form jadwal (hari, jam mulai/selesai, pilih playlist) dengan modal edit dan notifikasi real-time untuk aksi tambah/ubah/hapus.
- **Penanda Playlist Aktif** – Daftar playlist menampilkan badge “Sedang dipakai” untuk memudahkan identifikasi playlist yang terhubung ke jadwal streaming.
- **Toast Global** – Semua aksi playlist (create/update/delete) menggunakan toast konsisten sehingga feedback pengguna lebih jelas tanpa reload halaman.
